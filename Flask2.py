...
# this is the creation of my database in the form of classes as this makes it alot easier to addd to the databse along with reading off the database.
class User(db.Model):
    #User table
                    ...
                    if amount==0:
                        ...
                        for i in range(amount):
                            ...
                            try:
                                ...
                                print("https://image.tmdb.org/t/p/w500/" + str(data3["poster_path"]))
                                display.append("https://image.tmdb.org/t/p/w500/" + str(data3["poster_path"]))
                return render_template('Film.html', title=title, id=id, poster=poster, overview=overview, display=display, linkpop=linkpop,stop=stop)
    except:
        stop = 1
        return render_template('Film.html', stop=stop)
